                                ...
                                <form action="{{ route('news.search') }}" method="GET" role="search">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-lg" name="search"
                                            placeholder="@lang('lms.yangilik_search')">                              
                                         ...
                                         <div class="row row-cols-1 row-cols-2 g-4 " >
                                            <div class="col ">
                                                <div class="card border border-primary" style="width: 25rem; border-width: 6px;">
                                                    ...
                                                    <div class="card-body">
                                                    <h5 class="card-title">@lang('lms.yangilik_yaratish')</h5>
                                                    <p class="card-text">@lang('lms.yangilik_iltimos')</p>
                                                    <a href="{{ route('news.create') }}" class="btn btn-primary">@lang('lms.yangilik_yaratish')</a>
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col">
                                                <div class="card" style="width: 20rem;">
                                                    ...
                                                    <a href="{{ route('news.show', [$news2->id]) }}" class="btn btn-primary">@lang('lms.oqish')</a>
                                                    </div>
                                                </div> 
                                            </div>
                                            @endif
