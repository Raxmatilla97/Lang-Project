...
<style>
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">@lang('lms.modul_mazmuni_sahifasi')</li>
    </ol>
                                                    ...
                                                    @if(str_contains(url()->current(), '/modulMazmunis/category/shaxsiy_hujjatlar'))    
                                                        ...
                                                        <div class="col">
                                                            <div class="card" style="width: 20rem;">
                                                                ...
                                                                <a href="{{ route('modulMazmunis.show', [$modul->id]) }}" class="btn btn-primary">@lang('lms.oqish') </a>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        @endif
